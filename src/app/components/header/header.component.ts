    ...
    <header class="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-8 z-10">
      <div class="flex-1 max-w-md">
        <div class="relative group">
          ...
          <input class="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-lg py-2 pl-10 pr-4 focus:ring-2 focus:ring-primary/20 text-sm placeholder:text-slate-400 transition-all" placeholder="Search orders, customers, or analytics..." type="text"/>
        </div>
      </div>
      <div class="flex items-center gap-4">
        ...
        <button class="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-primary transition-colors">
          <span>English</span>
